...
<template>
  <div class="mt-3 space-y-3">
    ...
    <div class="rounded-2xl bg-white p-1">
      <uv-cell title="关闭广告" :label="userInfo.skipAD ? '人情往来账本会继续努力，期待得到你的认可！' : '页面广告已开启，人情往来账本因你更美好！'" :border="false">
        <template #value>
    ...
    <div class="rounded-2xl bg-white p-1">
      <uv-cell title="备案号" :border="false" value="渝ICP备17003755号-11X" />
      <uv-cell title="开源协议" :border="false" value="GPL-3.0 license" />
      <uv-cell title="隐私政策" :border="false" is-link @click="openPrivacyContract" />
      <uv-cell title="关于人情往来账本" is-link :border="false" url="/pages/about/index" />
    </div>
  </div>
</template>
